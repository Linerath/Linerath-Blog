...
INSERT INTO [dbo].[Articles]
     ...
     VALUES
		  ...
		  ,(N'Still Alive', N'This was a triumph.'+ CHAR(13) + 'I''m making a note here:'+ CHAR(13) + 'HUGE SUCCESS.'+ CHAR(13) + 'It''s hard to overstate my satisfaction.'+ CHAR(13)+ CHAR(13) + 'Aperture Science.'+ CHAR(13) + 'We do what we must because we can.'+ CHAR(13) + 'For the good of all of us'+ CHAR(13) + 'Except the ones who are dead.'+ CHAR(13)+ CHAR(13) + 'But there''s no sense crying over every mistake.'+ CHAR(13) + 'You just keep on trying till you run out of cake.'+ CHAR(13) + 'And the science gets done and you make a neat gun.'+ CHAR(13) + 'For the people who are still alive.'+ CHAR(13) + 'I''m not even angry.'+ CHAR(13)+ CHAR(13) + 'I''m being so sincere right now.'+ CHAR(13) + 'Even though you broke my heart and killed me.'+ CHAR(13) + 'And tore me to pieces.'+ CHAR(13) + 'And threw every piece into a fire.'+ CHAR(13) + 'As they burned it hurt because'+ CHAR(13) + 'I was so happy for you!'+ CHAR(13)+ CHAR(13) + 'Now these points of data make a beautiful line.'+ CHAR(13) + 'And we''re out of beta, we''re releasing on time.'+ CHAR(13) + 'So I''m GLaD I got burned.'+ CHAR(13) + 'Think of all the things we learned'+ CHAR(13) + 'For the people who are still alive.'+ CHAR(13)+ CHAR(13) + 'Go ahead and leave me.'+ CHAR(13) + 'I think I prefer to stay inside.'+ CHAR(13) + 'Maybe you''ll find someone else to help you.'+ CHAR(13) + 'Maybe Black Mesa...'+ CHAR(13) + 'THAT WAS A JOKE. Haha. FAT CHANCE.'+ CHAR(13) + 'Anyway, this cake is great.'+ CHAR(13) + 'It''s so delicious and moist.'+ CHAR(13)+ CHAR(13) + 'Look at me still talking when there''s science to do.'+ CHAR(13) + 'When I look out there it makes me GLaD I''m not you.'+ CHAR(13) + 'I''ve experiments to run there is research to be done'+ CHAR(13) + 'On the people who are still alive'+ CHAR(13)+ CHAR(13) + 'And believe me I am still alive.'+ CHAR(13) + 'I''m doing science and I''m still alive.'+ CHAR(13) + 'I feel FANTASTIC and I''m still alive.'+ CHAR(13) + 'While you''re dying I''ll be still alive.'+ CHAR(13) + 'And when you''re dead I will be still alive.'+ CHAR(13)+ CHAR(13) + 'Still alive', '20190129 05:26:00 PM')
GO
